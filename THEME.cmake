...
if (EXISTS "${OEM_THEME_DIR}/OEM.cmake")
    ...
    include ("${CMAKE_CURRENT_LIST_DIR}/PersonalCloud.cmake")
endif()
...
if(${APPLICATION_REV_DOMAIN} STREQUAL "com.seagate.personalcloud.stxfiles.macos")
    set(APPLICATION_REV_DOMAIN_INSTALLER "com.personalcloud.client")
else()
...
if(NOT CRASHREPORTER_EXECUTABLE)
    set(CRASHREPORTER_EXECUTABLE "${APPLICATION_SHORTNAME}_crash_reporter")
endif()
