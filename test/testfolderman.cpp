...
private slots:
    void testCheckPathValidityForNewFolder()
    {
        ...
        QVERIFY(dir.isValid());
        QDir dir2(dir.path());
        QVERIFY(dir2.mkpath(QStringLiteral("sub/PersonalCloud/folder/f")));
        QVERIFY(dir2.mkpath(QStringLiteral("PersonalCloud2")));
        ...
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/sub/PersonalCloud1")).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/PersonalCloud2/")).isNull());

        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/sub/PersonalCloud1/folder")).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/sub/PersonalCloud1/folder/f")).isNull());
        ...
        QVERIFY(QFile::link(dirPath + QStringLiteral("/sub/PersonalCloud1"), dirPath + QStringLiteral("/link3")));
        QVERIFY(QFile::link(dirPath + QStringLiteral("/sub/PersonalCloud1/folder"), dirPath + QStringLiteral("/link4")));
        ...
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/sub/PersonalCloud1/some/sub/path")).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/PersonalCloud2/blublu")).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/sub/PersonalCloud1/folder/g/h")).isNull());
        ...
        QDir(dirPath + QStringLiteral("/PersonalCloud2/")).removeRecursively();
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/PersonalCloud2/blublu")).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/PersonalCloud2/sub/subsub/sub")).isNull());
    ...
    void testFindGoodPathForNewSyncFolder()
    {
        ...
        QVERIFY(dir.isValid());
        QDir dir2(dir.path());
        QVERIFY(dir2.mkpath(QStringLiteral("sub/PersonalCloud1/folder/f")));
        QVERIFY(dir2.mkpath(QStringLiteral("PersonalCloud")));
        QVERIFY(dir2.mkpath(QStringLiteral("PersonalCloud2")));
        QVERIFY(dir2.mkpath(QStringLiteral("PersonalCloud2/foo")));
        QVERIFY(dir2.mkpath(QStringLiteral("sub/free")));
        QVERIFY(dir2.mkpath(QStringLiteral("free2/sub")));
        QString dirPath = dir2.canonicalPath();
        ...
        FolderMan *folderman = TestUtils::folderMan();
        QVERIFY(folderman->addFolder(
            newAccountState.get(), TestUtils::createDummyFolderDefinition(newAccountState->account(), dirPath + QStringLiteral("/sub/PersonalCloud/"))));
        QVERIFY(folderman->addFolder(
            newAccountState.get(), TestUtils::createDummyFolderDefinition(newAccountState->account(), dirPath + QStringLiteral("/PersonalCloud (2)/"))));

        // TEST

        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("oc")), dirPath + QStringLiteral("/oc"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("PersonalCloud")), dirPath + QStringLiteral("/PersonalCloud (3)"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("PersonalCloud2")), dirPath + QStringLiteral("/PersonalCloud2 (2)"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("PersonalCloud (2)")), dirPath + QStringLiteral("/PersonalCloud (2) (2)"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("PersonalCloud2/foo")), dirPath + QStringLiteral("/PersonalCloud2_foo"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("PersonalCloud2/bar")), dirPath + QStringLiteral("/PersonalCloud2_bar"));
        ...
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("PersonalCloud")), dirPath + QStringLiteral("/PersonalCloud (3)"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("PersonalCloud2")), QString(dirPath + QStringLiteral("/PersonalCloud (2)")));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("PersonalCloud (2)")), QString(dirPath + QStringLiteral("/PersonalCloud (2) (2)")));
