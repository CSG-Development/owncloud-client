...
private slots:
    void testCheckPathValidityForNewFolder()
    {
        ...
        QVERIFY(dir.isValid());
        QDir dir2(dir.path());
        QVERIFY(dir2.mkpath(QStringLiteral("sub/Curator/folder/f")));
        QVERIFY(dir2.mkpath(QStringLiteral("Curator2")));
        ...
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/sub/Curator1")).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/Curator2/")).isNull());

        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/sub/Curator1/folder")).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/sub/Curator1/folder/f")).isNull());
        ...
        QVERIFY(QFile::link(dirPath + QStringLiteral("/sub/Curator1"), dirPath + QStringLiteral("/link3")));
        QVERIFY(QFile::link(dirPath + QStringLiteral("/sub/Curator1/folder"), dirPath + QStringLiteral("/link4")));
        ...
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/sub/Curator1/some/sub/path")).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/Curator2/blublu")).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/sub/Curator1/folder/g/h")).isNull());
        ...
        QDir(dirPath + QStringLiteral("/Curator2/")).removeRecursively();
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/Curator2/blublu")).isNull());
        QVERIFY(!folderman->checkPathValidityForNewFolder(dirPath + QStringLiteral("/Curator2/sub/subsub/sub")).isNull());
    ...
    void testFindGoodPathForNewSyncFolder()
    {
        ...
        QVERIFY(dir.isValid());
        QDir dir2(dir.path());
        QVERIFY(dir2.mkpath(QStringLiteral("sub/Curator1/folder/f")));
        QVERIFY(dir2.mkpath(QStringLiteral("Curator")));
        QVERIFY(dir2.mkpath(QStringLiteral("Curator2")));
        QVERIFY(dir2.mkpath(QStringLiteral("Curator2/foo")));
        QVERIFY(dir2.mkpath(QStringLiteral("sub/free")));
        QVERIFY(dir2.mkpath(QStringLiteral("free2/sub")));
        QString dirPath = dir2.canonicalPath();
        ...
        FolderMan *folderman = TestUtils::folderMan();
        QVERIFY(folderman->addFolder(
            newAccountState.get(), TestUtils::createDummyFolderDefinition(newAccountState->account(), dirPath + QStringLiteral("/sub/Curator/"))));
        QVERIFY(folderman->addFolder(
            newAccountState.get(), TestUtils::createDummyFolderDefinition(newAccountState->account(), dirPath + QStringLiteral("/Curator (2)/"))));

        // TEST

        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("oc")), dirPath + QStringLiteral("/oc"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("Curator")), dirPath + QStringLiteral("/Curator (3)"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("Curator2")), dirPath + QStringLiteral("/Curator2 (2)"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("Curator (2)")), dirPath + QStringLiteral("/Curator (2) (2)"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("Curator2/foo")), dirPath + QStringLiteral("/Curator2_foo"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("Curator2/bar")), dirPath + QStringLiteral("/Curator2_bar"));
        ...
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("Curator")), dirPath + QStringLiteral("/Curator (3)"));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("Curator2")), QString(dirPath + QStringLiteral("/Curator (2)")));
        QCOMPARE(folderman->findGoodPathForNewSyncFolder(dirPath, QStringLiteral("Curator (2)")), QString(dirPath + QStringLiteral("/Curator (2) (2)")));
