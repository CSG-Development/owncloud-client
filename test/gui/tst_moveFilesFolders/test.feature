Feature: move file and folder
    ...
    Scenario: Move folder and file from level 5 sub-folder to sync root
        ...
        And user "Alice" has uploaded file with content "Curator" to "folder1/folder2/folder3/folder4/folder5/lorem.txt" in the server
        ...
        Then as "Alice" the file "lorem.txt" should have the content "Curator" in the server
    ...
    Scenario: Move two folders and a file down to the level 5 sub-folder
        ...
        And user "Alice" has uploaded file with content "Curator test" to "testFile.txt" in the server
        And user "Alice" has set up a client with default settings
        ...
        And the user waits for the files to sync
        Then as "Alice" the file "folder1/folder2/folder3/folder4/folder5/testFile.txt" should have the content "Curator test" in the server
