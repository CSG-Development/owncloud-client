...
@OnScenarioStart
def hook(context):
    # set PersonalCloud config file path
    ...
    set_config('clientConfigFile', os.path.join(config_dir, 'PersonalCloud.cfg'))
    ...
    set_config('syncConnectionName', "Personal" if get_config("ocis") else "PersonalCloud")
