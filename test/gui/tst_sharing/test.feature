...
Feature: Sharing
    ...
    Scenario: simple sharing with user
        ...
        And user "Alice" has uploaded file with content "PersonalCloud test text file 0" to "/textfile0.txt" in the server
    ...
    Scenario: sharing file and folder with user who has some other shares
        ...
        And user "Alice" has created folder "simple-folder" in the server
        And user "Alice" has uploaded file with content "PersonalCloud test text file" to "textfile.txt" in the server
    ...
    Scenario: Share files/folders with special characters in their name
        ...
        And user "Alice" has uploaded file with content "PersonalCloud test text file 0" to "/$ample1#.txt" in the server
        And user "Alice" has set up a client with default settings
    ...
    Scenario: try to self share a file/folder
        Given user "Alice" has uploaded file with content "PersonalCloud test text file" to "/textfile.txt" in the server
    ...
    Scenario: Progress indicator should not be visible after unselecting the password protection checkbox while sharing through public link
        Given user "Alice" has uploaded file with content "PersonalCloud test text file 0" to "/textfile0.txt" in the server
        And user "Alice" has set up a client with default settings
    ...
    Scenario: sharee edits shared files and again try to edit after write permission is revoked
        ...
        And the user closes the sharing dialog
        And user "Brian" tries to overwrite the file "textfile.txt" with content "overwrite PersonalCloud test text file"
        ...
        Then as "Brian" the file "textfile.txt" should have the content "PersonalCloud test text file" in the server
        And as "Brian" the file "FOLDER/simple.txt" should have the content "some content" in the server
        And as "Alice" the file "textfile.txt" should have the content "PersonalCloud test text file" in the server
    ...
    Scenario: sharee renames the shared file and folder
        Given user "Alice" has uploaded file with content "PersonalCloud test text file 0" to "textfile.txt" in the server
        And user "Alice" has created folder "FOLDER" in the server
        And user "Brian" has been created on the server with default attributes and without skeleton files
        And user "Alice" has shared file "textfile.txt" on the server with user "Brian" with "all" permissions
