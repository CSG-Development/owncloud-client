...
function(add_vfs_plugin)
    ...
    if(APPLE)
        set_target_properties(vfs_${__PLUGIN_NAME} PROPERTIES LIBRARY_OUTPUT_DIRECTORY "$<TARGET_FILE_DIR:curator>/../PlugIns/")
    ...
    if (TARGET curator)
        add_dependencies(curator vfs_${__PLUGIN_NAME})
    endif()
    if (TARGET cmd)
