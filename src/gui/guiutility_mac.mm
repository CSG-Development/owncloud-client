...
QString Utility::socketApiSocketPath()
{
    ...
    // Example for developer builds (with ad-hoc signing identity): "" "com.seagate.personalcloud.stxfiles.macos" ".socketApi"
    // Example for official signed packages: "57HJ3KH2XC." "com.seagate.personalcloud.stxfiles.macos" ".socketApi"
