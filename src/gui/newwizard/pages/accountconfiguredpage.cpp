#include "accountconfiguredpage.h"
...
AccountConfiguredPage::AccountConfiguredPage(
    ...
    : _ui(new ::Ui::AccountConfiguredPage)
{
    _ui->setupUi(this);
    ...
    auto setRecommendedOption = [](CRadioButton *radioButton) {
    ...
    connect(_ui->configureSyncManuallyRadioButton, &CRadioButton::toggled, this, [this](bool checked) {
...
AccountConfiguredPage::~AccountConfiguredPage() noexcept
{
    delete _ui;
}

QString AccountConfiguredPage::syncTargetDir() const
{
    return QDir::toNativeSeparators(_ui->localDirectoryLineEdit->text());
}

SyncMode AccountConfiguredPage::syncMode() const
{
...
bool AccountConfiguredPage::validateInput()
{
    // nothing to validate here
    return true;
}

void AccountConfiguredPage::setShowAdvancedSettings(bool showAdvancedSettings)
{
