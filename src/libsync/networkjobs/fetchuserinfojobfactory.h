...
class APPLICATIONSYNC_EXPORT FetchUserInfoResult
{
public:
...
class APPLICATIONSYNC_EXPORT FetchUserInfoJobFactory : public AbstractCoreJobFactory
{
public:
...
Q_DECLARE_METATYPE(APP::FetchUserInfoResult)
